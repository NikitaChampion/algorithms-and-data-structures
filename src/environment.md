...
Совсем скоро на сервере будет использоваться новая схема тестирования решений, а точнее, будет отлавливаться большее число ошибок за счет использования других ключей компиляции. Цель этой заметки &mdash; помочь вам получить такой же эффект на своей системе.

Помимо этого, описанные здесь рекомендации позволят вам организовать более качественное тестирование кода.

На сервере будет компилироваться 2 варианта вашего решения, а именно:
